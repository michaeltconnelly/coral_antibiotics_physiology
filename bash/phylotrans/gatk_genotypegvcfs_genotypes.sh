...
#$ -cwd
#$ -j y
#$ -N gatk_genotypegvcfs_genotypes
#$ -o /scratch/nmnh_corals/connellym/projects/anti_phys/bash/jobs/gatk_genotypegvcfs_genotypes.log
#$ -m bea
#$ -M connellym@si.edu
#
# ----------------Modules------------------------- #
...
-V ${prodir}/outputs/phylotrans_Pdam/samples_genotypes.g.vcf.gz \
-o ${prodir}/outputs/phylotrans_Pdam/samples_genotypes.vcf.gz
#
